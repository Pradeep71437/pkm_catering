                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Veg புலாவ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Veg புலாவ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Fried ரைஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Fried ரைஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="தந்துரி புலாவ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>தந்துரி புலாவ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பனீர் புலாவ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பனீர் புலாவ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="காஷ்மீரி புலாவ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>காஷ்மீரி புலாவ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Ghee ரைஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Ghee ரைஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="சீரக ரைஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>சீரக ரைஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="வாங்கி பாத்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>வாங்கி பாத்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="டால் பாத்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>டால் பாத்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பிசிபேளா பாத்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பிசிபேளா பாத்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கதம்பம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கதம்பம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="புதினா ரைஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>புதினா ரைஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மல்லி ரைஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மல்லி ரைஸ்</span></li>
                                    <h6 class="px-3 p-3">Raithas</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Onion Raitha" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Onion Raitha</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Cucumber Raitha" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Cucumber Raitha</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Veg Raitha" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Veg Raitha</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Boondhi Raitha" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Boondhi Raitha</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Tomato Raitha" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Tomato Raitha</span></li>
                                    <h6 class="px-3 p-3">சிப்ஸ்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="நேந்திரம் சிப்ஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>நேந்திரம் சிப்ஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Finger Chips" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Finger Chips</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மினி வத்தல்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மினி வத்தல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மினி பப்பட்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மினி பப்பட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="அப்பளம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>அப்பளம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பப்படம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பப்படம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="இலை வடாம்(மினி)" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>இலை வடாம் (மினி)</span></li>
                                    <h6 class="px-3 p-3">ரசம்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="இஞ்சி லெமன் ரசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>இஞ்சி லெமன் ரசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="அன்னாசி ரசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>அன்னாசி ரசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="லெமன் சீரக ரசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>லெமன் சீரக ரசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மைசூர் ரசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மைசூர் ரசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="தக்காளி ரசம் (SPL)" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>தக்காளி ரசம் (SPL)</span></li>
                                    <h6 class="px-3 p-3">பொறியல்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="உருளை ரோஸ்ட்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>உருளை ரோஸ்ட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மிக்ஸ் வெஜ் பொறியல்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மிக்ஸ் வெஜ் பொறியல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="சேனை ரோஸ்ட்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>சேனை ரோஸ்ட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கத்திரிக்காய் சாப்ஸ்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கத்திரிக்காய் சாப்ஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பிண்டி Fry" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பிண்டி Fry</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="சேம்பு ரோஸ்ட்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>சேம்பு ரோஸ்ட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கோஸ் பட்டாணி பொறியல்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கோஸ் பட்டாணி பொறியல்</span></li>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">பாயசம்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="இளநீர் பாயசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>இளநீர் பாயசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மில்க்மெய்டு கேரட்கீர்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மில்க்மெய்டு கேரட்கீர்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பாதாம் கீர்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பாதாம் கீர்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பிஸ்தா கீர்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பிஸ்தா கீர்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="அவல் மில்க்மெய்டு பாயசம்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>அவல் மில்க்மெய்டு பாயசம்</span></li>
                                    <h6 class="px-3 p-3">ஊறுகாய்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மாங்காய் தொக்கு" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மாங்காய் தொக்கு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கட்மாங்காய் ஊறுகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கட்மாங்காய் ஊறுகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Veg ஊறுகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Veg ஊறுகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பூண்டு - இஞ்சி ஊறுகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பூண்டு - இஞ்சி ஊறுகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="புளி - இஞ்சி ஊறுகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>புளி - இஞ்சி ஊறுகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ஆவக்காய் ஊறுகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ஆவக்காய் ஊறுகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பட்டர் பாத்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பட்டர் பாத்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மோர் மிளகாய்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மோர் மிளகாய்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="வத்தகுழம்பு" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>வத்தகுழம்பு</span></li>
                                    <h6 class="px-3 p-3">Ice Cream And Scoop Ice Cream</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="வெந்நிலா" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>வெந்நிலா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ஸ்ட்ராபெர்ரி" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ஸ்ட்ராபெர்ரி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பட்டர் ஸ்காட்ச்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பட்டர் ஸ்காட்ச்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="சாக்கோ Chip" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>சாக்கோ Chip</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ப்ளாக் கரண்ட்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ப்ளாக் கரண்ட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ராஜ்போக்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ராஜ்போக்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பிஸ்தா" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பிஸ்தா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ட்யூட்டி Fruity" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ட்யூட்டி Fruity</span></li>
                                    <h6 class="px-3 p-3">Kulfi</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கேசர் குல்பி" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கேசர் குல்பி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பான் குல்பி" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பான் குல்பி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மலாய் குல்பி" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மலாய் குல்பி</span></li>
                                    <h6 class="px-3 p-3">பால்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மசாலா பால்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மசாலா பால்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="பனங்கற்கண்டு பால்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>பனங்கற்கண்டு பால்</span></li>
                                    <h6 class="px-3 p-3">Beeda</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Pan Beeda" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Pan Beeda</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Sweet Beeda" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Sweet Beeda</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கல்கத்தா Beeda" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கல்கத்தா Beeda</span></li>
                                    <h6 class="px-3 p-3">வெத்தலை</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="கும்பகோண வெத்தலை" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>கும்பகோண வெத்தலை</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="சீவல்" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>சீவல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="ரசிகலால் பாக்கு" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>ரசிகலால் பாக்கு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="Sweet சோம்பு" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>Sweet சோம்பு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="firdaydinner[]" value="மவுத் Fresh" <?php echo in_array('', $firdaydinner) ? 'checked' : ''; ?>> <span>மவுத் Fresh</span></li>
                                </div>
                            </div>
                        </ul>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">ஸ்வீட்ஸ்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="ட்ரை Fruit அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>ட்ரை Fruit அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="பீட்ருட் அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>பீட்ருட் அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="அசோகா அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>அசோகா அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="காசி அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>காசி அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="கேரட் அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>கேரட் அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="தம்ரூட் அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>தம்ரூட் அல்வா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="Coconut அல்வா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>Coconut அல்வா</span></li>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">டிபன்</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="இட்லி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>இட்லி (Idly)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="நெய் பொங்கல்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>நெய் பொங்கல் (Nei Pongal)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மசால் தோசை - மல்லி சட்னி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மசால் தோசை - மல்லி சட்னி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="Plain தோசை - தக்காளி சட்னி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>Plain தோசை - தக்காளி சட்னி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="கல் தோசை - சாம்பார்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>கல் தோசை - சாம்பார்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="பூரி மாசலா" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>பூரி மாசலா</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="இடியாப்பாம் - குர்மா, தேங்காய் பால்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>இடியாப்பாம் - குர்மா, தேங்காய் பால்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மினி சாம்பார் இட்லி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மினி சாம்பார் இட்லி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="வெஜ் ஊத்தப்பம்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>வெஜ் ஊத்தப்பம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>ராகி - தோசை</span></li>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">வடை</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மெது வடை - தேங்காய் சட்னி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மெது வடை - தேங்காய் சட்னி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மினிசாம்பார் வடை - Spl சட்னி" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மினிசாம்பார் வடை - Spl சட்னி</span></li>
                                    <h6 class="px-3 p-3">Fresh Juice</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="இஞ்சி லெமன் மின்ட்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>இஞ்சி லெமன் மின்ட்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="கமலா ஆரஞ்சு" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>கமலா ஆரஞ்சு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மாம்பழம்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மாம்பழம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="க்ரேப்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>க்ரேப்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="மசாலா மோர்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>மசாலா மோர்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaymor[]" value="பானகம்" <?php echo in_array('', $secdaymor) ? 'checked' : ''; ?>> <span>பானகம்</span></li>
                                </div>
                            </div>
                        </ul>
                    </div>
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="Fruits Salad" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>Fruits Salad</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="தக்காளி ஜாம்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>தக்காளி ஜாம்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="Fruits Jam" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>Fruits Jam</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பழம், சர்க்கரை" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பழம், சர்க்கரை</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="கேரட்கோஸ்மல்லி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>கேரட்கோஸ்மல்லி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பருப்புகோஸ்மல்லி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பருப்புகோஸ்மல்லி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="தயிர்பச்சடி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>தயிர்பச்சடி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="கல்யாண அவியல்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>கல்யாண அவியல்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மலபார் அவியல்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மலபார் அவியல்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பூசணிக்காய் மொச்சை புளிப்புக்கூட்டு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பூசணிக்காய் மொச்சை புளிப்புக்கூட்டு</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="சௌசௌகடலை புளிப்புக்கூட்டு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>சௌசௌகடலை புளிப்புக்கூட்டு</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="புளியோதரை" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>புளியோதரை</span></li>

                                        </div>
                                    <div class="col-sm-4">
                                        <h6 class="px-3 p-3">பொறியல்</h6>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="வாழைக்காய்கறமது" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>வாழைக்காய்கறமது</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="சேனைக்கிழங்கு கறமது" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>சேனைக்கிழங்கு கறமது</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பிண்டி Fry" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பிண்டி Fry</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="உருளைக்கிழங்கு பொடிமாஸ்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>உருளைக்கிழங்கு பொடிமாஸ்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="கோஸ் உசிலி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>கோஸ் உசிலி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பீன்ஸ் உசிலி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பீன்ஸ் உசிலி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="புடலங்காய் உசிலி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>புடலங்காய் உசிலி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="தயிர்வடை" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>தயிர்வடை</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="உருளை Chips" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>உருளை Chips</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பருப்பு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பருப்பு</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="நெய்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>நெய்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="கல்யாண சாம்பார்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>கல்யாண சாம்பார்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மோர்க்குழம்பு தக்காளி ரசம்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மோர்க்குழம்பு தக்காளி ரசம்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மைசூர் ரசம்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மைசூர் ரசம்</span></li>
                                    </div>
                                    <div class="col-sm-3">
                                        <h6 class="px-3 p-3">பாயசம்</h6>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="அக்கார அடிசில்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>அக்கார அடிசில்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பாசிபருப்பு பாயசம்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பாசிபருப்பு பாயசம்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="கடலைபருப்பு பாயசம்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>கடலைபருப்பு பாயசம்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="அடைப்ரதமன்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>அடைப்ரதமன்</span></li>
                                        <h6 class="px-3 p-3">ஸ்வீட்ஸ்</h6>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="முந்திரிகேக்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>முந்திரிகேக்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பாதாம்கேக்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பாதாம்கேக்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மில்க்கேக்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மில்க்கேக்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பாதுஷா" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பாதுஷா</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மினிலட்டு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மினிலட்டு</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மினிஜாங்கிரி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மினிஜாங்கிரி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மில்க்மைசூர்பாகு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மில்க்மைசூர்பாகு</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="காராசேவ்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>காராசேவ்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="காராபூந்தி" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>காராபூந்தி</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="பகளாபாத்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>பகளாபாத்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="அப்பளம் வத்தகுழம்பு கடாரங்காய் ஊறுகாய்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>அப்பளம் வத்தகுழம்பு கடாரங்காய் ஊறுகாய்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="லெமன் ஊறுகாய்" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>லெமன் ஊறுகாய்</span></li>
                                        <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayaft[]" value="மாவடு" <?php echo in_array('', $secdayaft) ? 'checked' : ''; ?>> <span>மாவடு</span></li>
                                    </div>
                            </div>
                        </ul>
                    </div>
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayeve[]" value="ஸ்வீட்" <?php echo in_array('', $secdayeve) ? 'checked' : ''; ?>> <span>ஸ்வீட் (SWEET)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayeve[]" value="பஜ்ஜி" <?php echo in_array('', $secdayeve) ? 'checked' : ''; ?>> <span>பஜ்ஜி (Bajji)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayeve[]" value="தேங்காய் சட்னி" <?php echo in_array('', $secdayeve) ? 'checked' : ''; ?>> <span>தேங்காய் சட்னி (Coconut Chutney)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdayeve[]" value="காபி" <?php echo in_array('', $secdayeve) ? 'checked' : ''; ?>> <span>காபி (Coffee)</span></li>
                                </div>
                            </div>
                        </ul>
                    </div>
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="குலோப் ஜாமுன்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>குலோப் ஜாமுன் (Gulab Jamun)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="பாதாம் கேக்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>பாதாம் கேக் (Badam Cake)</span></li>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">MAIN DISH</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="மணத்தக்காளி வத்த குழம்பு" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>மணத்தக்காளி வத்த குழம்பு (Manathakali Vaththa Kozhambu)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="தக்காளி ரசம்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>தக்காளி ரசம் (Thakali Rasam)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="ஜவ்வரிசி கீர்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>ஜவ்வரிசி கீர் (Javvarisi Kheer)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="சேமியா கீர்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>சேமியா கீர் (Semiya Kheer)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="தயிர்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>தயிர் (Curd)</span></li>
                                </div>
                                <div class="col-sm-4">
                                    <h6 class="px-3 p-3">SIDE DISH</h6>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="தயிர்பச்சடி" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>தயிர்பச்சடி (Thayir Pachadi)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="கத்திரிக்காய் பொறியல்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>கத்திரிக்காய் பொறியல் (Kathirikai Poriyal)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="கேரட் பொரியல்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>கேரட் பொரியல் (Carrot Poriyal)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="நெய் & பருப்பு" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>நெய் & பருப்பு (Ghee & Dhal)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="ஊறுகாய்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>ஊறுகாய் (Mango Pickle)</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="secdaydinner[]" value="அப்பளம்" <?php echo in_array('', $secdaydinner) ? 'checked' : ''; ?>> <span>அப்பளம் (Appalam)</span></li>
                                </div>
                            </div>
                        </ul>
                    </div>
                ...
                <div class="col-lg-4 mt-4 align-items-center justify-content-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-12">
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="புரூட் ஜாம்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>புரூட் ஜாம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="தயிர்பச்சடி" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>தயிர்பச்சடி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="வெஜ். கூட்டு" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>வெஜ். கூட்டு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="உருளை பொடிமாஸ்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>உருளை பொடிமாஸ்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="நெய் & பருப்பு" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>நெய் & பருப்பு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="வெஜ். வடை" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>வெஜ். வடை</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="அப்பளம் & வத்தல்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>அப்பளம் & வத்தல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="மிளகு குழம்பு" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>மிளகு குழம்பு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="லெமன் ரசம்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>லெமன் ரசம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="சர்க்கரை பொங்கல்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>சர்க்கரை பொங்கல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="guestfood[]" value="தயிர்,ஊறுகாய்" <?php echo in_array('', $guestfood) ? 'checked' : ''; ?>> <span>தயிர்,ஊறுகாய்</span></li>
                                </div>
                            </div>
                        </ul>
                    </div>
                ...
                <div class="col-lg-4 mt-4 align-items-center justify-content-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-12">
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="packetfood[]" value="சர்க்கரை பொங்கல்" <?php echo in_array('', $packetfood) ? 'checked' : ''; ?>> <span>சர்க்கரை பொங்கல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="packetfood[]" value="புளியோதரை & வத்தல்" <?php echo in_array('', $packetfood) ? 'checked' : ''; ?>> <span>புளியோதரை & வத்தல்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="packetfood[]" value="தயிர் சாதம் & ஊறுகாய்" <?php echo in_array('', $packetfood) ? 'checked' : ''; ?>> <span>தயிர் சாதம் & ஊறுகாய்</span></li>
                                    </div>
                            </div>
                        </ul>
                    </div>
                        ...
                        <ul class="dropdown-menu" style="height: 250px; width: 100%; overflow: auto;">
                            <div class="row">
                                <div class="col-lg-12 col-sm-4">
                                    ...
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="மஞ்சள் பொடி" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>மஞ்சள் பொடி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="விரளி மஞ்சள்" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>விரளி மஞ்சள்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="களி பாக்கு" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>களி பாக்கு</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="சந்தனம்" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>சந்தனம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="வெற்றிலை" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>வெற்றிலை</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="நவதான்யம்" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>நவதான்யம்</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="நெல்பொறி" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>நெல்பொறி</span></li>
                                    <li class="px-3 m-2"><input type="checkbox" style="color: black;" name="vedicset[]" value="வாழைப்பழம்" <?php echo in_array('', $vedicset) ? 'checked' : ''; ?>> <span>வாழைப்பழம்</span></li>
